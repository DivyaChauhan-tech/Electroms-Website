  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto flex justify-center">
        <div className="w-full max-w-sm bg-white/10 backdrop-blur-xs p-7 shadow-lg">

          <h3 className="text-white text-3xl font-semibold mb-6 text-left">
            Get in Touch
          </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pb-3">
              <div>
                <input
                  ...
                  className="w-full p-2 rounded-sm outline-none bg-white placeholder-gray-400 text-black"
                />
                {errors.name && (
