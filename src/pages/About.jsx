  ...
  return (
    <Layout>
      <div className="moderneducationtechnology-page relative">
        <img src={about} alt="Modern Education Technology" className="w-full h-40 sm:h-56 md:h-auto object-cover -mt-8 sm:mt-0" />
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white text-2xl sm:text-xl md:text-3xl lg:text-4xl font-bold text-center drop-shadow-lg">
            About Us
          </h1>
        </div>
      </div>
